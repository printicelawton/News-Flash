...
$("#submit").click(function (event) {
  categoryValue = categoryChoice.options[categoryChoice.selectedIndex].value;
  ...
  $(".card").attr(
    "style",
    "border: #4a4a4a solid .25em; width: border-box; cursor: pointer;"
  );
});
...
function getWeather() {
  ...
  var geocodeUrl =
    ...
    selectedCity +
    "&key=2098cd8a74444263890876ca7ea94a84";
  fetch(geocodeUrl)
    ...
    .then(function (data) {
      ...
      var oneCallUrl =
        ...
        "&lon=" +
        geoLng +
        "&appid=802248b8a798a6e1e59be31a4560e2ec";
      ...
      fetch(oneCallUrl)
        ...
        .then(function (data) {
          ...
          if (currentUv < 3) {
            document
              .getElementById("showCurrentUv")
              .setAttribute("style", "background-color: rgb(37, 200, 37)");
          } else if (currentUv < 6) {
            document
              .getElementById("showCurrentUv")
